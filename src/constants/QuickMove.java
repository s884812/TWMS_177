...
public enum QuickMove {
    ...
    public enum QuickMoveNPC {//UI.wz\UIWindow2.img\EasyMove\
        ...
        被派來的藍多普(7, false, 0, 10, ""),
        被派來的露西亞(8, false, 0, 10, ""),
        戴彼得(9, false, 9010040, 10, ""),
        ...
        楓之谷拍賣場(20, true, 0, 30, "可以透過愛格里曲來訪問楓之谷拍賣場."),
        ...
        private QuickMoveNPC(int type, boolean show, int id, int level, String desc) {
            this.value = (long) Math.pow(2, type);
            this.type = type;
            this.show = show;
            this.id = id;
            this.level = level;
        ...
        private QuickMoveNPC(int value, int type, boolean show, int id, int level, String desc) {
            this.value = (long) Math.pow(2, value);
            this.type = type;
            this.show = show;
            this.id = id;
            this.level = level;
