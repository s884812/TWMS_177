...
//			System.err.println("Hide > 1 ("+ hide +")");
    ...
    private String getMapStringName(int mapid) {
        ...
        } else if ((mapid >= 100000000 && mapid < 200000000) || (mapid >= 749080172 && mapid <= 749080254) || (mapid >= 862000000 && mapid <= 862000004) || mapid == 910050100 || mapid == 910240000 || mapid == 910510002) {
        ...
        } else if ((mapid >= 743000000 && mapid < 744000000) || (mapid >= 744000020 && mapid <= 744000041) || (mapid >= 745000000 && mapid < 746000000) || (mapid >= 749050900 && mapid < 749060000) || (mapid >= 749080142 && mapid <= 749080600)) {
