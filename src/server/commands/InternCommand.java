        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            if (!ii.itemExists(itemId)) {
                ...
                if (itemId < 5001000 && itemId >= 5000000) {
                    MapleInventoryManipulator.addById(c, itemId, (short) 1, "", MaplePet.createPet(itemId, MapleInventoryIdentifier.getInstance()), 45, MapleInventoryManipulator.DAY, c.getPlayer().getName() + "使用 " + splitted[0] + "指令製作");
                    return 1;
                }
                Item item;
