...
public class AdminCommand {
    ...
    public static class 自動註冊 extends CommandExecute {
        ...
        @Override
        public int execute(MapleClient c, String[] splitted) {
            ServerConfig.autoRegister = !ServerConfig.autoRegister;
            c.getPlayer().dropMessage(0, "自動註冊狀態: " + (ServerConfig.autoRegister ? "開啟" : "關閉"));
            System.out.println("自動註冊狀態: " + (ServerConfig.autoRegister ? "開啟" : "關閉"));
            return 1;
        }
    }
