...
public class MapleItemInformationProvider {
    ...
    protected Map<Integer, StructAndroid> androidInfo = new HashMap();
    ...
    public final Item scrollEquipWithId(final Item equip, final Item scroll, final boolean ws, final MapleCharacter chr, final int vegas) {
        if (equip.getType() == 1) { // See Item.java
            ...
            if (ItemFlag.LUCKY_DAY.check(equip.getFlag()) && !GameConstants.isPotentialScroll(scroll.getItemId()) && !GameConstants.isBonusPotentialScroll(scroll.getItemId()) && !GameConstants.isEquipScroll(scroll.getItemId()) && (!GameConstants.isSpecialScroll(scroll.getItemId()) || GameConstants.isSpecialScrollWithPer(scroll.getItemId())) && !GameConstants.isResetScroll(scroll.getItemId())) {
            ...
            if (GameConstants.isPotentialScroll(scroll.getItemId())) {
                ...
                scrollType += "潛能附加捲軸";
            } else if (GameConstants.isBonusPotentialScroll(scroll.getItemId())) {
                scrollType = "附加潛在能力附加捲軸";
                success = GameConstants.getBonusPotentialScrollSucc(scroll.getItemId());
                curse = GameConstants.getBonusPotentialScrollCurse(scroll.getItemId());
            } else if (GameConstants.isEquipScroll(scroll.getItemId()) || GameConstants.isResetScroll(scroll.getItemId())) {
                success = stats == null || !stats.containsKey("success") ? 0 : stats.get("success");
                ...
                if (GameConstants.isLuckydayScroll(scroll.getItemId())) {
                    if (GameConstants.isProtectionScroll(scroll.getItemId())) {
                        scrollType = "幸運日+防爆捲軸";
                    } else {
                        scrollType = "幸運日捲軸";
                    }
                } else if (GameConstants.isProtectionScroll(scroll.getItemId())) {
                    scrollType = "防爆捲軸";
                } else if (GameConstants.isSafeScroll(scroll.getItemId())) {
                    scrollType = "安全捲軸";
                } else if (GameConstants.isScrollSafeScroll(scroll.getItemId())) {
                    scrollType = "捲軸保護卡";
                } else if (GameConstants.isCleanSlate(scroll.getItemId())) {
                    scrollType = "白醫捲軸";
                } else if (GameConstants.isChaosScroll(scroll.getItemId())) {
                    scrollType = "混沌捲軸";
                } else {
                    scrollType = "普通捲軸";
                }
                success = stats == null || !stats.containsKey("success") ? 0 : GameConstants.isTablet(scroll.getItemId()) ? GameConstants.getSuccessTablet(scroll.getItemId(), nEquip.getLevel()) : stats.get("success");
                curse = stats == null || !stats.containsKey("cursed") ? 0 : GameConstants.isTablet(scroll.getItemId()) ? GameConstants.getCurseTablet(scroll.getItemId(), nEquip.getLevel()) : stats.get("cursed");
            ...
            if (GameConstants.isPotentialScroll(scroll.getItemId()) || GameConstants.isBonusPotentialScroll(scroll.getItemId()) || GameConstants.isEquipScroll(scroll.getItemId()) || (GameConstants.isSpecialScroll(scroll.getItemId()) && !GameConstants.isSpecialScrollWithPer(scroll.getItemId())) || GameConstants.isResetScroll(scroll.getItemId()) || Randomizer.nextInt(100) <= success) {
                switch (scroll.getItemId()) {
                    case 2040727: { // Spikes on shoe, prevents slip鞋子防滑卷軸10%
                        short flag = nEquip.getFlag();
                        flag |= ItemFlag.SPIKES.getValue();
                        nEquip.setFlag(flag);
                        break;
                    }
                    case 2041058: { // Cape for Cold protection披風防寒卷軸10%
                        short flag = nEquip.getFlag();
                    ...
                    default: {
                        if (GameConstants.isLuckydayScroll(scroll.getItemId())) {//幸運日
                            short flag = nEquip.getFlag();
                        ...
                        if (GameConstants.isProtectionScroll(scroll.getItemId())) {//保護捲軸
                            ...
                            nEquip.setFlag(flag);
                            break;
                        } else if (GameConstants.isSafeScroll(scroll.getItemId())) {//安全捲軸
                            short flag = nEquip.getFlag();
                            flag = (short) (flag | ItemFlag.SLOTS_PROTECT.getValue());
                            nEquip.setFlag(flag);
                            break;
                        } else if (GameConstants.isScrollSafeScroll(scroll.getItemId())) {//捲軸保護卡
                            short flag = nEquip.getFlag();
                            flag = (short) (flag | ItemFlag.SCROLL_PROTECT.getValue());
                            nEquip.setFlag(flag);
                            break;
                        } else if (GameConstants.isCleanSlate(scroll.getItemId())) {//白醫捲軸
                            nEquip.setUpgradeSlots((byte) (nEquip.getUpgradeSlots() + (stats == null ? 0 : stats.get("recover"))));
                            break;
                        } else if (GameConstants.isChaosScroll(scroll.getItemId())) {//混沌捲軸
                            final int z = GameConstants.getChaosNumber(scroll.getItemId());
                            int increase = Randomizer.nextBoolean() ? 1 : (GameConstants.isChaosForGoodness(scroll.getItemId())) || (isNegativeScroll(scroll.getItemId())) ? 1 : -1;
                            if (nEquip.getStr() > 0) {
                            ...
                            for (int i = 0; i < Math.min(getForceUpgrade(scroll.getItemId()), GameConstants.getEnhanceTimes(nEquip.getItemId()) - nEquip.getEnhance()); i++) {
                            ...
                            if (scroll.getItemId() >= 2049700 && scroll.getItemId() < 2049750) {//稀有潛能捲軸
                                nEquip.resetPotential(2, nEquip.getPotential3() != 0);
                            } else if (scroll.getItemId() >= 2049750 && scroll.getItemId() < 2049759) {//罕見潛能捲軸
                                nEquip.resetPotential(3, nEquip.getPotential3() != 0);
                            } else if (scroll.getItemId() == 2049780 || scroll.getItemId() == 2049782) {//傳說潛能捲軸
                                nEquip.resetPotential(4, nEquip.getPotential3() != 0);
                            ...
                            if (scroll.getItemId() == 2048306) {//3行附加潛能捲軸
                                nEquip.resetBonusPotential(true);
                            } else {
                                nEquip.resetBonusPotential();
                            }
                            break;
                        } else if (GameConstants.isResetScroll(scroll.getItemId())) {//回真捲軸
                            if (equip.getType() != 1) {
                                return equip;
                            }
                            if (Randomizer.nextInt(100) > success) {
                ...
                if (!GameConstants.isCleanSlate(scroll.getItemId()) && !GameConstants.isSpecialScroll(scroll.getItemId()) && !GameConstants.isEquipScroll(scroll.getItemId()) && !GameConstants.isPotentialScroll(scroll.getItemId()) && !GameConstants.isBonusPotentialScroll(scroll.getItemId())) {
                ...
                if (!ws && !GameConstants.isCleanSlate(scroll.getItemId()) && !GameConstants.isSpecialScroll(scroll.getItemId()) && !GameConstants.isEquipScroll(scroll.getItemId()) && !GameConstants.isPotentialScroll(scroll.getItemId()) && !GameConstants.isBonusPotentialScroll(scroll.getItemId())) {
                    short oldFlag = nEquip.getFlag();
                    if (ItemFlag.SLOTS_PROTECT.check(oldFlag)) {
                        nEquip.setFlag((short) (oldFlag - ItemFlag.SLOTS_PROTECT.getValue()));
                        chr.showMessage(11, "由卷軸的效果來，不會扣掉可以升級的次數。");
                    } else if (GameConstants.isAzwanScroll(scroll.getItemId())) {
                        nEquip.setUpgradeSlots((byte) (nEquip.getUpgradeSlots() - eqstats.get("tuc")));
                    } else {
                        nEquip.setUpgradeSlots((byte) (nEquip.getUpgradeSlots() - 1));
                    }
