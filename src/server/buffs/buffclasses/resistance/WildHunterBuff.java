    ...
    public void handleBuff(MapleStatEffect eff, int skill) {
        switch (skill) {
            ...
            case 33101005:// Call of the Wild
                ...
                eff.statups.put(MapleBuffStat.DAMAGE_TAKEN_BUFF, eff.info.get(MapleStatInfo.x));
                eff.statups.put(MapleBuffStat.DODGE_CHANGE_BUFF, eff.info.get(MapleStatInfo.x));
                break;
