    ...
    public void handleBuff(MapleStatEffect eff, int skill) {
        switch (skill) {
			...
			case 24111003: //幸運卡牌守護
				...
				eff.statups.put(MapleBuffStat.MP_BOOST_PERCENT, eff.info.get(MapleStatInfo.indieMmpR));
				break;
			case 24111005: //月光賜福
				eff.statups.clear();
			...
			case 24121003: //最終的夕陽
				...
				break;
			case 24121004: //艾麗亞祝禱
				eff.statups.put(MapleBuffStat.DAMAGE_RATE, eff.info.get(MapleStatInfo.damR) + 10);
				eff.statups.put(MapleBuffStat.CRITICAL_RATE, eff.info.get(MapleStatInfo.damR) + 10);
				break;
			case 24121008://楓葉祝福
