...
public class MapleSlideMenu {//UI.wz\UIWindow2.img\SlideMenu\
    ...
    public static class SlideMenu0 {
        ...
        public static enum 次元之鏡 { //Updated to V120 without quests
            ...
            PQ43(43, "The Seed", 0, 0, 100, above, 0, 0, true),
            ...
            次元之鏡(int id, String name, int map, int portal, int minLevel, int maxLevel, int requieredQuest, int requieredQuestState, boolean show) {
                this.id = id;
                this.name = name;
                this.map = map;
                this.portal = portal;
            ...
            次元之鏡(int id, String name, int map, String portal_string, int minLevel, int maxLevel, int requieredQuest, int requieredQuestState, boolean show) {
                this.id = id;
                this.name = name;
                this.map = map;
            ...
            public static 次元之鏡 getById(int id) {
                for (次元之鏡 mirror : 次元之鏡.values()) {
                    if (mirror.getId() == id) {
                        return mirror;
                    }
                }
        ...
        public static int[] getDataIntegers(int id) {
            System.out.println(次元之鏡.getById(id).getMap());
            次元之鏡 mirror = 次元之鏡.getById(id);
