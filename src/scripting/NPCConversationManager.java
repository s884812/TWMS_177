...
//public void teachSkill(int id, int skillevel, byte masterlevel, long expiration) {
    ...
    public void sendAttackOnTitanScore(int type) {
        c.getSession().write(CField.UIPacket.sendAttackOnTitanScore(type, 1));
    }
    ...
    public void dragonShoutReward(int reward) {
        ...
        if (invtype.equals(MapleInventoryType.EQUIP) && !GameConstants.isThrowingStar(itemid) && !GameConstants.isBullet(itemid)) {
            ...
            item.setGMLog("從腳本 " + this.id + " (" + id2 + ") (The Dragon's Shout PQ)中獲得 時間: " + FileoutputUtil.CurrentReadable_Time());
            ...
            MapleInventoryManipulator.addById(c, itemid, (short) 1, "Hyperious", null, 0, MapleInventoryManipulator.DAY, "從腳本 " + this.id + " (" + id2 + ") 中獲得 時間: " + FileoutputUtil.CurrentReadable_Time());
        }
