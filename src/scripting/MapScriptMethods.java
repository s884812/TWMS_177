...
//                    c.getSession().write(CField.UIPacket.getDirectionInfo((byte) 4, 9072200));
            ...
            case "cannon_tuto_direction1": {
                ...
                c.getSession().write(EffectPacket.showWZEffect(0x17, "Effect/Direction4.img/cannonshooter/face04"));//173 ?
                c.getSession().write(EffectPacket.showWZEffect(0x17, "Effect/Direction4.img/cannonshooter/out01"));//173 ?
...
//                c.getSession().write(UIPacket.getDirectionInfo(4, 1096000));
            ...
            default: {
                if (c.getPlayer().isShowErr()) {
                    c.getPlayer().showInfo("onUserEnter", true, "找不到地圖onUserEnter：" + scriptName + c.getPlayer().getMap());
                    c.getPlayer().showInfo("onUserEnter", true, "開始打開對應JS腳本");
                }
    ...
    private static void showIntro(final MapleClient c, final String data) {
        c.getSession().write(UIPacket.IntroDisableUI(true));
        c.getSession().write(UIPacket.IntroLock(true));
        c.getSession().write(EffectPacket.showWZEffect(0x17, data));//176.3 - goArcher
    }
