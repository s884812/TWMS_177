...
public class MaplePet implements Serializable {
    ...
    public static enum PetFlag {
        ...
        PET_BUFF(0x80, 5190007, -1), // 寵物召喚
        PET_DRAW(0x100, 5190008, -1), // 自言自語
        PET_DIALOGUE(0x200, 5190010, -1), // 寵物自動加持技能
        寵物萬能療傷藥(0x400, 5190009, -1), // 寵物萬能療傷藥自動使用技能
        PET_SMART(0x800, 5190011, -1), // 寵物訓練技能
        寵物巨大化(0x1000, 5190012, -1); // 寵物巨大技能
