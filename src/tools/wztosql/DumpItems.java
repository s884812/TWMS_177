...
public class DumpItems {
    ...
    private final MapleDataProvider item, character, string = MapleDataProviderFactory.getDataProvider(new File(System.getProperty("wzpath") + "/String.wz"));
    ...
    protected final MapleData getStringData(final int itemId) {
        ...
        } else if ((itemId >= 1010000 && itemId < 1040000) || (itemId >= 1122000 && itemId < 1123000) || (itemId >= 1132000 && itemId < 1210000)) {
            data = eqpStringData;
            cat = "Eqp/Accessory";
