...
public class DumpOxQuizData {
    ...
    static CharsetEncoder asciiEncoder = Charset.forName("big5").newEncoder();
    ...
    public void dumpOxData() throws SQLException {
        ...
        stringProvider = MapleDataProviderFactory.getDataProvider(new File(System.getProperty("wzpath") + "/Etc.wz"));
