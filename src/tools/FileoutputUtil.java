...
public class FileoutputUtil {
    ...
    public static final String Acc_Stuck = "日誌/日誌_AccountStuck.rtf",
            ...
            CommandEx_Log = "日誌/命令_異常.txt", //PQ_Log = "Log_PQ.rtf"
    ...
    private static final String FILE_PATH = "日誌/" + sdf.format(Calendar.getInstance().getTime()) + "/";// + sdf.format(Calendar.getInstance().getTime()) + "/"
    ...
    public static void printError(final String name, final String s) {
        logToFile(FILE_PATH + ERROR + name, s + "\r\n---------------------------------\r\n");
    }
    ...
    public static void saveSetting(final String file, final String msg) {
