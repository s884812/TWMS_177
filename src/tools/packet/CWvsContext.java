...
//        mplew.writeShort(SendPacketOpcode.YELLOW_CHAT.getValue());
    ...
    public static byte[] getMapleTipMsg() {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        ...
        public static byte[] giveBuff(int buffid, int bufflength, Map<MapleBuffStat, Integer> statups, MapleStatEffect effect) {
            ...
            for (Map.Entry<MapleBuffStat, Integer> stat : statups.entrySet()) {
                if (!stat.getKey().canStack()) {
                    System.out.println(stat.getKey().name()); // 查看排列順序用                    
                    if (specialBuff) {
            ...
            IsSpecialBuff(mplew, statups, effect);
...
//            mplew.writeZeroBytes(69); //防止長度不夠Error 38 用的，對填錯值無效...
        ...
        public static void IsSpecialBuff(MaplePacketLittleEndianWriter mplew, Map<MapleBuffStat, Integer> statups, MapleStatEffect effect) {
            ...
            if (statups.containsKey(MapleBuffStat.DARK_AURA)) {
                mplew.write(1);
            }
            if (statups.containsKey(MapleBuffStat.YELLOW_AURA)) {
                mplew.write(1);
            }
            if (statups.containsKey(MapleBuffStat.BLUE_AURA)) {
                mplew.write(1);
            }
            ...
            if (statups.containsKey(MapleBuffStat.PRESSURE_VOID)) {
                mplew.write(0);
            }
            ...
            if (statups.containsKey(MapleBuffStat.IDA_UNK_BUFF6)) {
                mplew.write(0);
            }
            ...
            if (statups.containsKey(MapleBuffStat.IDA_UNK_BUFF9)) {
                mplew.write(0);
            }
            ...
            if (statups.containsKey(MapleBuffStat.IDA_SPECIAL_BUFF_10)) {
                mplew.writeInt(0);
            }
            if (statups.containsKey(MapleBuffStat.IDA_UNK_BUFF15)) {
                mplew.writeInt(0);
            }
