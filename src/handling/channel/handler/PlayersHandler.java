...
//        System.err.println("onReward");
    ...
    public static void UseChronosphere(LittleEndianAccessor slea, MapleClient c, MapleCharacter chr) {
        ...
        if (GameConstants.isBossMap(toMapId)) {
            c.getSession().write(CSPacket.getTrockMessage((byte) 11));
            c.getSession().write(CWvsContext.errorChronosphere());
            return;
        }
        ...
        c.getSession().write(CWvsContext.showChronosphere(chr));
    }
}
